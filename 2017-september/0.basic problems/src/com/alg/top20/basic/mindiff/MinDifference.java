...
public class MinDifference {
	...
	public static void main(String[] args) {
		...
		System.out.println("Min Diff: " + findMinDiff1(in1, in2));
		long end = System.currentTimeMillis();
		System.out.println("Time taken-1:" + (end - start) / 1000.0 + " seconds");

		start = System.currentTimeMillis();
		System.out.println("Min Diff: " + findMinDiff2(in1, in2));
		end = System.currentTimeMillis();
		System.out.println("Time taken-2:" + (end - start) / 1000.0 + " seconds");
